...
final class Plugin
{
    ...
    public static function boot()
    {
        ...
        add_action('before_woocommerce_init', [self::class, 'declare_woocommerce_compatibility']);
    ...
    public static function init()
    {
        ...
        if (version_compare(WC_VERSION, '8.0', '<')) {
            add_action('admin_notices', [self::class, 'woocommerce_version_notice']);
    ...
    {
        $schedules['adoology_five_minutes'] = [
    ...
    public static function declare_woocommerce_compatibility()
    {
        if (class_exists('Automattic\\WooCommerce\\Utilities\\FeaturesUtil')) {
            FeaturesUtil::declare_compatibility('custom_order_tables', ADOOLOGY_PLUGIN_FILE, true);
        }
    }
